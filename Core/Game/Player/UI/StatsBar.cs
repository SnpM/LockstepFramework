...
namespace Lockstep.UI
{
	public class StatsBar : MonoBehaviour
	{
		...
		{
            if (RTSPlayerInterfacingHelper.GUIManager.CameraChanged && TrackedAgent.IsVisible) {
				this.UpdatePos ();
				this.UpdateScale ();
        ...
        static GUIManager GUIManager {get {return RTSPlayerInterfacingHelper.GUIManager;}}
